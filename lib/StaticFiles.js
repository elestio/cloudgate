                    ...
                    try {
                        if (fs.existsSync(fullPath)) {
                            ...
                            if ( finalPath == "/index.html" ){
                                // 404 on index.html in the root folder
...
<body>
    <H1>Welcome to CloudGate!</H1>
    <span>
        If you see this page, CloudGate is working. Please check our documentation for more details:
        <br/>
        <a href='https://github.com/jbenguira/cloudgate'>https://github.com/jbenguira/cloudgate</a>
        <br/><br/>
        Thanks for using CloudGate
    </span>
</body>
                                ...
                                //tools.GzipResponse(res, defaultContent);
