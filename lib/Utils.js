...
module.exports.prepare = (res, req) => {
...
function addGetterSetter(req, res, name, content){
    Object.defineProperty(req, name, content);
}
...
module.exports.GzipResponse = GzipResponse;
function GzipResponse(res, content)
{
    //res.end(content);
    //return;

    //TODO: check if GZIP is supported
    res.writeHeader("content-type", "text/html;charset=utf-8;");
    res.writeHeader('Content-Encoding', 'gzip');
   
    //Async way ... slower
    /*
    zlib.gzip(content, function (_, result) {  // The callback will give you the 
        if (!res.aborted) {
            res.end(result);
        }
    });
    */
    ...
    //This is 2 times faster compared to the async code above!
